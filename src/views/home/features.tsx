  ...
  return (
    <section id="what-is-it" className="pt-8 pb-16 md:pt-14 xl:pb-18">
      ...
      <div className="v-container">
        <ul className="mt-16 grid grid-cols-2 gap-4 md:grid-cols-4 md:gap-6 xl:gap-8">
          {gallery.map(({ image, alt }) => (
            <li key={image.src} className="h-36 md:h-40 xl:h-64">
              <Image
                src={image}
                alt={alt}
                sizes="(min-width: 1280px) 256px, (min-width: 768px) 22vw, 47vw"
